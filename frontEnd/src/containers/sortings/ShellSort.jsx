...
import codeSnippets from '../../common/snippets/bodySnippet/codeSnippets'; // Update path for shell sort snippets
    ...
    return (
        <div style={{ background: 'linear-gradient(135deg, #1a1a1a, #3f3f3f)', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <header style={styles.header}>
                <h1 style={styles.algorithmName}>Shell Sort Visualizer</h1>
                ...
                <div className="code-snippet" style={styles.codeSnippet}>
                    ...
                    <div style={styles.codeBlockWrapper}>
                        <SyntaxHighlighter 
                            ...
                            wrapLines={true}
                        >
                            {codeSnippets.shellSort[selectedLanguage]}
                        </SyntaxHighlighter>
                    </div>
                </div>
            </div>
...
export default ShellSortingVisualizer;
